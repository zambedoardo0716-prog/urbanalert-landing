...
const contactEmail = "urbanalert@email.it";
...
export function LandingPage() {
  ...
  return (
    <main className="overflow-hidden">
      <AnimatePresence>{contactToast && <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="contact-toast"><CheckCircle2 size={15} /> Email copiata negli appunti</motion.div>}</AnimatePresence>
